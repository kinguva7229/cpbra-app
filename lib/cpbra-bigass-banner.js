...
import "./cpbra-cta.js"; // Import the CTA component
    ...
    return [
      ...
      css`
        ...
        .side-block {
          ...
          max-width: 420px;
          width: 100%;
          /* Consistent spacing managed by the gap property */
        ...
        .actions {
          display: flex;
          flex-direction: column;
          /* Since only one item is left, the gap here mostly controls padding below the button */
