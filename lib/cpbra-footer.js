...
export class CpbraFooter extends DDDSuper(LitElement) {
    ...
    static get styles() {
        ...
        :host {
          display: block;
          /* UPDATED: Use global theme variables for dark mode responsiveness */
          background-color: var(--theme-bg-content-dark); 
          color: var(--theme-color-text-light);
          padding: var(--ddd-spacing-8) var(--ddd-spacing-4);
          font-family: var(--ddd-font-navigation);
          border-top: 4px solid var(--theme-color-accent); /* Use accent color for border */
        ...
        .social-link {
          /* UPDATED: Use theme variable for link color */
          color: var(--theme-color-text-light);
          opacity: 0.7;
        ...
        .social-link:hover {
          opacity: 1;
          /* UPDATED: Use theme variable for hover accent color */
