...
export class CpbraHeroBanner extends DDDSuper(I18NMixin(LitElement)) {
  static get tag() {
    return "cpbra-banner";
  }
  ...
  render() {
    return html`
      <div class="hero-banner" style="background-image: url('${this.bgimg}')">
        <div class="side-block">
          ...
          <div class="actions">
            <cpbra-cta 
              ...
              @click="${(e) => {
        e.preventDefault();
        window.history.pushState({}, '', '/?page=join');

        document.querySelector('cpbra-app').dispatchEvent(new CustomEvent('route-changed', {
          detail: { route: '/join' },
          bubbles: true,
          composed: true
        }));
...
customElements.define(CpbraHeroBanner.tag, CpbraHeroBanner);
